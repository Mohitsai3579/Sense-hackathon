  ...
  return (
    <div className="pt-20 bg-white">
      <div className="container mx-auto px-4 py-12 text-center">
        <h1 className="text-3xl md:text-4xl font-bold text-[#0078B7] mb-4">SENSE HACKATHON</h1>
        <p className="text-lg md:text-xl italic text-gray-700 mb-8">"Fueling Innovation, Powering Tomorrow."</p>
